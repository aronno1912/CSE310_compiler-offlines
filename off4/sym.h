   ...
   public:
     ...
     SymbolInfo(string name, string type) {
        ...
        SymbolInfo(string name, string type,string ret,string varType,vector<string>paraList,bool d,vector<string>argl) {
         ...
         SymbolInfo(string name, string type,int so,bool b,string ret,string varType,vector<string>paraList,bool d) {
            this->name = name;
            this->type = type;
            this->returnType= ret;
            this->variableType=varType;
...

{
  ...
  private:
      ...
      int bucketNum;
      int scopeCount; //scope table er nam
      string id;
 ...
 void SetId(){
  ...
  bool Insert(string name,string type)
      ...
      bool Insert2(string name, string type="", string returnType = "", string variableType = "", vector<string>param = vector<string>(), bool Defined = false)
    {
     ...
     bool Insert3(string name, string type="",int stackoff=0,bool b=false, string returnType = "", string variableType = "", vector<string>param = vector<string>(), bool Defined = false)
    {
        int index= SDBMHash(name) % bucketNum;

        SymbolInfo* node = new SymbolInfo(name,type,stackoff,b,returnType, variableType, param, Defined);
       ...
       for ( i = 0; i < bucketNum; i++)
       {
           ...
           {    j=i;
             string var=listPrint->variableType;
               ...
               str.append(str2);
               str.append("> ");}
             str.append(to_string(listPrint->getStackOffset()));
...
bool Insert2(string name, string type="", string returnType = "", string variableType = "", vector<string>param = vector<string>(), bool Defined = false)
    ...
    {  
        ...
        if(current_scopeTable->Insert3(name, type,stackoff,b, returnType, variableType, param, Defined))
        {
            return true;
    ...
    string getScopeName(string symbolName) {
        ScopeTable* cur = this->current_scopeTable;
        while(cur != NULL) 
        {
            SymbolInfo* ret = cur->LookUp(symbolName);
